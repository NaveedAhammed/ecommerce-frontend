...
const Button: React.FC<ButtonProps> = ({
	...
	switch (varient) {
		...
		case "link":
			varientClasses =
				"text-primary underline-offset-4 hover:underline focus:shadow-none hover:shadow-none";
			break;
		default:
			break;
	}
	switch (size) {
		case "default":
			sizeClasses = "h-10 px-4 py-2 rounded-md";
			break;
		case "sm":
			sizeClasses = "h-9 rounded-md px-3 rounded-md";
			break;
		case "lg":
			sizeClasses = "h-11 rounded-md px-8 rounded-md";
			break;
		case "icon":
